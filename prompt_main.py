...
@File    : prompt_main.py
@Author  : qy
@Date    : 2025/9/10 09:26
"""

from typing import List, Dict, Any, Optional
from policy_utils_port import get_policy_object,get_policy_domain,get_policy_condition,get_policy_filename, format_polict_text
...
"""
    ...
    # check_mode=2 提示词：只输出政策原文，满足/不满足/不确定
    elif check_mode == 2:
        base_prompt = f"""
你是一位精通政府政策解读和企业合规分析的专家。
